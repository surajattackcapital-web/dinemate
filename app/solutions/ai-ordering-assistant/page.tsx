        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-300">Process more orders in less time with instant AI responses</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">💰 20% Higher Upsells</h3>
              <p className="text-gray-300">AI suggests relevant add-ons at the perfect moment</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">✅ 99% Order Accuracy</h3>
              <p className="text-gray-300">Eliminate miscommunication and reduce remakes</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">🌍 Multi-Language Support</h3>
              <p className="text-gray-300">Serve diverse customers in their preferred language</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="background-glass p-6 rounded-lg text-center">
              ...
              <p className="text-gray-300">Handle unlimited phone orders simultaneously without busy signals or hold times. Perfect for takeout and delivery operations.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">🚗</div>
              <h3 className="font-bold text-xl mb-3">Drive-Thru</h3>
              <p className="text-gray-300">Reduce drive-thru wait times with voice ordering AI that processes orders faster than human staff while maintaining accuracy.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">💬</div>
              <h3 className="font-bold text-xl mb-3">Chat & Messaging</h3>
              <p className="text-gray-300">Enable ordering through WhatsApp, SMS, Facebook Messenger, and web chat for maximum convenience.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-300">Process high-volume orders during lunch and dinner rushes. Our AI handles multiple drive-thru lanes simultaneously, reducing wait times and increasing throughput by up to 3x.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Pizza & Delivery Restaurants</h3>
              <p className="text-gray-300">Take phone orders 24/7 without missing calls. The AI captures delivery addresses, payment preferences, and special instructions with 99% accuracy, integrating directly with your POS system.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Multi-Location Chains</h3>
              <p className="text-gray-300">Deploy consistent ordering experiences across all locations. Centralized AI training ensures brand consistency while allowing local menu customization.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Ghost Kitchens & Cloud Brands</h3>
              <p className="text-gray-300">Manage orders from multiple delivery platforms and brands with a single AI system. Route orders intelligently and optimize kitchen capacity.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <p className="text-gray-400 text-sm">Direct integration</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Full API access</p>
            </div>
            <div>
              <p className="font-bold mb-2">Custom POS</p>
              <p className="text-gray-400 text-sm">API integration available</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-300">Order accuracy rate</p>
            </div>
            <div>
              <div className="text-4xl font-bold gradient-text mb-2">3x</div>
              <p className="text-gray-300">Faster order processing</p>
            </div>
            <div>
              <div className="text-4xl font-bold gradient-text mb-2">25%</div>
              <p className="text-gray-300">Increase in revenue</p>
            </div>
            <div>
