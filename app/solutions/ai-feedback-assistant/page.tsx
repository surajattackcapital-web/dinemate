        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-600">Gather feedback via SMS, email, QR codes, and in-app surveys</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3 flex items-center gap-2">
                <span>🧠</span> Sentiment Analysis
              </h3>
              <p className="text-gray-600">AI understands context and emotions in guest responses</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3 flex items-center gap-2">
                <span>🚨</span> Real-Time Alerts
              </h3>
              <p className="text-gray-600">Get notified immediately about negative experiences</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3 flex items-center gap-2">
                <span>📈</span> Trend Tracking
              </h3>
              <p className="text-gray-600">Identify patterns and track improvements over time</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-600">Track staff performance and service speed across all touchpoints</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold mb-2">Food Quality Insights</h3>
              <p className="text-gray-600">Identify popular dishes and areas for menu improvement</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold mb-2">Operational Issues</h3>
              <p className="text-gray-600">Spot problems with cleanliness, wait times, or facilities</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="background-glass p-6 rounded-lg text-center">
              ...
              <p className="text-gray-600">Send post-visit surveys via text message. High response rates with convenient one-tap feedback.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">✉️</div>
              <h3 className="font-bold text-xl mb-3">Email Surveys</h3>
              <p className="text-gray-600">Automated email campaigns with branded surveys. Perfect for detailed feedback collection.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">📷</div>
              <h3 className="font-bold text-xl mb-3">QR Codes</h3>
              <p className="text-gray-600">Table tents and receipt QR codes for instant feedback while the experience is fresh.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">🌐</div>
              <h3 className="font-bold text-xl mb-3">Web Forms</h3>
              <p className="text-gray-600">Embedded forms on your website for online order feedback and general inquiries.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">⭐</div>
              <h3 className="font-bold text-xl mb-3">Review Monitoring</h3>
              <p className="text-gray-600">Aggregate Google, Yelp, and TripAdvisor reviews for comprehensive sentiment tracking.</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-4xl mb-4">💬</div>
              <h3 className="font-bold text-xl mb-3">Social Media</h3>
              <p className="text-gray-600">Monitor and analyze mentions, comments, and direct messages across social platforms.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">Track competitor reviews and ratings to identify opportunities and stay ahead.</p>
            </div>
            <div className="text-center">
              <h3 className="font-bold text-xl mb-3">Market Positioning</h3>
              <p className="text-gray-600">Understand your strengths and weaknesses relative to similar restaurants in your area.</p>
            </div>
            <div className="text-center">
              <h3 className="font-bold text-xl mb-3">Industry Benchmarks</h3>
              <p className="text-gray-600">Compare your metrics against industry standards and top performers in your category.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-600">Catch dissatisfied guests before they leave negative public reviews. Proactive issue resolution can turn potential 1-star reviews into 5-star experiences.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Staff Training & Development</h3>
              <p className="text-gray-600">Identify training opportunities based on guest feedback. Recognize top performers and provide targeted coaching where needed.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Menu Optimization</h3>
              <p className="text-gray-600">Discover which dishes guests love and which need improvement. Make data-driven decisions about menu changes and seasonal specials.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Marketing Insights</h3>
              <p className="text-gray-600">Understand what guests love most about your restaurant. Use authentic feedback in marketing campaigns and social media content.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-600">More feedback collected</p>
            </div>
            <div>
              <div className="text-4xl font-bold gradient-text mb-2">80%</div>
              <p className="text-gray-600">Response rate via SMS</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-600">Average rating increase</p>
            </div>
          </div>
        </section>
