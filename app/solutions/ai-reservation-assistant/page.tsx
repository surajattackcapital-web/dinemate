        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="service-card background-glass">
              ...
              <p className="text-gray-300">Instant booking confirmations via SMS and email</p>
            </div>
            <div className="service-card background-glass">
              <div className="text-4xl mb-4">🔔</div>
              <h3 className="font-bold text-xl mb-3">Smart Reminders</h3>
              <p className="text-gray-300">Reduce no-shows with timely guest reminders</p>
            </div>
            <div className="service-card background-glass">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="font-bold text-xl mb-3">Table Optimization</h3>
              <p className="text-gray-300">Maximize capacity with intelligent seating</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-300">Booking availability</p>
            </div>
            <div>
              <div className="text-5xl font-bold gradient-text mb-2">100%</div>
              <p className="text-gray-300">Booking accuracy</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-300">Track birthdays, anniversaries, and VIP guests. AI automatically flags special occasions and suggests personalized touches.</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🍷</div>
              <h3 className="font-bold text-xl mb-3">Preference Tracking</h3>
              <p className="text-gray-300">Remember dietary restrictions, seating preferences, and favorite dishes. Provide personalized service every visit.</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">📧</div>
              <h3 className="font-bold text-xl mb-3">Automated Communication</h3>
              <p className="text-gray-300">Send confirmations, reminders, and thank you messages automatically. Keep guests engaged before and after their visit.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-300">Manage exclusive reservations with white-glove service. Handle waitlists for coveted time slots, coordinate tasting menus, and maintain detailed guest profiles for personalized experiences.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Casual & Family Dining</h3>
              <p className="text-gray-300">Handle high-volume reservations during weekends and holidays. Reduce phone calls and free up host staff to focus on greeting and seating guests efficiently.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Hotel Restaurants</h3>
              <p className="text-gray-300">Coordinate reservations with hotel guest services. Sync room charges, honor elite status, and provide seamless experiences for hotel guests and outside diners.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Event Venues & Private Dining</h3>
              <p className="text-gray-300">Manage large party reservations, private events, and buyouts. Coordinate menus, billing, and special requirements with automated workflows.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-300">Reservations sync with your POS for seamless service. Track covers, pre-orders, and special requests directly in your system.</p>
            </div>
            <div>
              <h3 className="font-bold text-xl mb-3">CRM Integration</h3>
              <p className="text-gray-300">Build comprehensive guest profiles. Track visit history, preferences, and lifetime value across all touchpoints.</p>
            </div>
            <div>
              <h3 className="font-bold text-xl mb-3">Marketing Automation</h3>
              <p className="text-gray-300">Target guests with personalized campaigns. Send re-engagement emails, birthday offers, and loyalty rewards automatically.</p>
            </div>
            <div>
              <h3 className="font-bold text-xl mb-3">Calendar Sync</h3>
              <p className="text-gray-300">Integrate with Google Calendar, Outlook, and other scheduling tools for staff coordination and planning.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-300">Less phone time</p>
            </div>
            <div>
              <div className="text-4xl font-bold gradient-text mb-2">15%</div>
              <p className="text-gray-300">Increased covers</p>
            </div>
            <div>
