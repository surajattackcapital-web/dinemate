        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="background-glass p-6 rounded-lg text-center">
              ...
              <p className="text-gray-300">Maintain exclusivity while optimizing reservations</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-5xl mb-4">👨‍👩‍👧‍👦</div>
              <h3 className="font-bold text-xl mb-3">Family Restaurants</h3>
              <p className="text-gray-300">Manage high volume with efficiency</p>
            </div>
            <div className="background-glass p-6 rounded-lg text-center">
              <div className="text-5xl mb-4">🍕</div>
              <h3 className="font-bold text-xl mb-3">Casual Dining</h3>
              <p className="text-gray-300">Speed up service and reduce wait times</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            ...
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-300">Labor costs continue to climb while profit margins shrink. Our AI solutions reduce dependency on large staff teams, cutting operational expenses without sacrificing service quality or guest satisfaction.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Guest Experience Expectations</h3>
              <p className="text-gray-300">Modern diners expect seamless digital experiences, instant responses, and personalized service. Meet these expectations with AI that remembers preferences, handles special requests, and ensures consistent excellence.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-2">Competition & Market Saturation</h3>
              <p className="text-gray-300">Stand out in a crowded market with cutting-edge technology. Restaurants using AI attract tech-savvy customers, earn higher reviews, and build reputations for innovation and convenience.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">A 5-location upscale restaurant group implemented DineMate across all properties:</p>
              <ul className="text-gray-300 space-y-2">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">A popular 200-seat Italian restaurant solved their weekend bottleneck:</p>
              <ul className="text-gray-300 space-y-2">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-300">Toast, Square, Clover, Lightspeed, and more. Direct integration for order flow and payment processing.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">Reservation Platforms</h3>
              <p className="text-gray-300">OpenTable, Resy, Yelp Reservations. Sync bookings across all channels automatically.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">Delivery Services</h3>
              <p className="text-gray-300">DoorDash, Uber Eats, Grubhub. Consolidate orders from all platforms into one system.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-gray-300">Guests served monthly</p>
            </div>
            <div>
              <div className="text-4xl font-bold gradient-text mb-2">$15M+</div>
              <p className="text-gray-300">Additional revenue generated</p>
            </div>
            <div>
