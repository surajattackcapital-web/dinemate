    ...
    <div className="wrapper padding-section-large">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="service-card background-glass">
              ...
              <p className="text-gray-600">Where every interaction is personalized, efficient, and delightful</p>
            </div>
            <div className="service-card background-glass">
              <div className="text-5xl mb-4">🌍</div>
              <h3 className="font-bold text-xl mb-3">Global Impact</h3>
              <p className="text-gray-600">Serving businesses worldwide with localized AI solutions</p>
            </div>
            <div className="service-card background-glass">
              <div className="text-5xl mb-4">💡</div>
              <h3 className="font-bold text-xl mb-3">Continuous Innovation</h3>
              <p className="text-gray-600">Always pushing boundaries in AI and hospitality tech</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 background-glass p-12 rounded-2xl text-center">
          ...
          <blockquote className="text-2xl text-gray-600 italic mb-6 max-w-3xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="background-glass p-6 rounded-lg">
              ...
              <p className="text-gray-600">We succeed when our customers succeed. Every decision starts with their needs.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">🔬 Innovation-Driven</h3>
              <p className="text-gray-600">We embrace cutting-edge AI and our ai voice agent for restaurants while maintaining practical, proven solutions.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">🤝 Partnership Mindset</h3>
              <p className="text-gray-600">We're not just a vendor — we're your long-term technology partner.</p>
            </div>
            <div className="background-glass p-6 rounded-lg">
              <h3 className="font-bold text-xl mb-3">✨ Excellence Always</h3>
              <p className="text-gray-600">From AI accuracy to customer support, we deliver exceptional quality.</p>
            </div>
          </div>
        </section>
